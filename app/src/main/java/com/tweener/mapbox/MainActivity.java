...
//                .target(new LatLng(48.8598, 2.37436))
                .zoom(16)
                .build());
        ...
        mapView.getMapAsync(mapboxMap -> {
            ...
            mapboxMap.addMarker(new MarkerViewOptions().position(new LatLng(48.860254, 2.37493515)));
            mapboxMap.addMarker(new MarkerViewOptions().position(new LatLng(48.85989402, 2.37486541)));
